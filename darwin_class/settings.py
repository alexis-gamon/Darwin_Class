"""
Django settings for darwin_class project.
...
SECRET_KEY = 'django-insecure-l$%62kq4qy(on5crf+vde0s_7f6%d@wjlej9u-awmr+v@vl9^^'
...
ROOT_URLCONF = 'darwin_class.urls'
...
WSGI_APPLICATION = 'darwin_class.wsgi.application'
